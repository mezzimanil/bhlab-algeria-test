    ...
    <div style="background: url({{ asset('image/white.jpg') }})" class="jumbotron bg-cover text-white">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-5">
                ...
                -->
                    <div class="contact-map size33">
                        
                        <iframe  src="https://maps.google.com/maps?q=BH%20Lab%20Alg%C3%A9rie&t=&z=13&ie=UTF8&iwloc=&output=embed"  width="1000" height="450" frameborder="0" style="border:0; margin:0 auto;" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
